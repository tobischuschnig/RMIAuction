...
//		System.out.println(bid.toString()); // funkt
		long wer = System.currentTimeMillis();
		String wert = "ID: 17    Description: Beschreibung10    Highestbid: 0.0    from: none\nID: 18    Description: Beschreibung7    Highestbid: 0.0    from: none";
		String[] wert1 = wert.split(" ");
		for (int i = 0; i < wert1.length;i++) {
//			System.out.println(i+"    "+wert1[i]);
			if(wert1[i].contains("ID")) {
				System.out.println(wert1[i+1]);
			}
		}
		
		System.out.println(System.currentTimeMillis()-(System.currentTimeMillis()-10000));
